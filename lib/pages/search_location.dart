...
class _SearchLocationState extends State<SearchLocation> {
  List<Location> previousLocations = [
    Location(name: 'Entrepreneurship, Innovation & Service Centre', latitude: 5.75886, longitude: -0.21748),
    Location(name: 'Engineering Workshop', latitude: 5.75905, longitude: -0.21769),
  ];
  ...
  List<Location> allLocations = [
    ...
    Location(name: 'Entrepreneurship, Innovation & Service Centre', latitude: 5.75886, longitude: -0.21748),
    Location(name: 'Engineering Workshop', latitude: 5.75905, longitude: -0.21769),
    Location(name: 'Natembea Health Centre', latitude: 5.75927, longitude: -0.21803),
    Location(name: 'Fabrication Lab (Fab Lab)', latitude: 5.75948, longitude: -0.21829),
    ...
    Location(name: 'King Engineering Building', latitude: 5.75955, longitude: -0.21934),
